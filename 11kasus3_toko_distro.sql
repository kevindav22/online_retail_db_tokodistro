...
SELECT TOP 1 kategori_produk.nama_kategori, COUNT(produk.id_produk) AS jumlah_barang
FROM kategori_produk
JOIN produk ON kategori_produk.id_kategori = produk.id_kategori
GROUP BY kategori_produk.nama_kategori
